...
## Thông Tin Nhóm Và Cá Nhân

**Tên nhóm:** AwesomeTeam

| Họ và tên | Email | Vai trò / Đóng góp cá nhân |
|---|---|---|
| Lê Mạnh Cương | lemanhcuong_t67@hus.edu.vn | Trưởng nhóm, tổng hợp Problem Scan và chọn bài toán chính |
| Nguyễn Tuấn Anh | anhtt44t@gmail.com | Phân tích Quick Problem Cards và kiểm tra metric |
| Lê Tiến Minh | mle409640@gmail.com | Thiết kế prompt prototype và adversarial tests |
| Vũ Ngọc Thiện | vungocthien843@gmail.com | Phác thảo workflow hiện tại và xác định bottleneck |
| Hoàng Duy Linh | hduylinh7@gmail.com | Chuẩn hóa nội dung, AI log và reflection |
| Nguyễn Tuấn Anh | tuanhhhh204@gmail.com | Review boundary, evaluation và tính nhất quán bài nộp |
